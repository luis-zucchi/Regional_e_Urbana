...
estoque_de_emprego <- read_excel("D:/Pessoal/Luis_Souza/Fase 3/Desligamentos.xlsx")
...
###########################################
####$$########################
arquivo_excel <- "desligamentos nao agregada.xlsx"
...
arquivo_excel <- "desligamentos_rgint.xlsx"
