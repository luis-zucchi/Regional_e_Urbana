...
# gerar media de skill por municipio, para cada grande regiao
...
caminho_excel <- "D:/Pessoal/Luis_Souza/Agropecuaria/rais skills/todos os setores/medias todos os setores.xlsx"
...
diretorio <- "D:/Pessoal/Luis_Souza/Agropecuaria/rais skills/todos os setores/"
